...
<html>
	...
	<body>
		...
		<form class="form-horizontal" role="form" method="post" action="movie">
		  	<div class="form-group">
		    	<label for="ccname" class="col-sm-2 control-label">Name as in Credit Card</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="ccname" placeholder="Name">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="ccnumber" class="col-sm-2 control-label">Credit Card Number</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="ccnumber" placeholder="Credit Card Number">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="cccsv" class="col-sm-2 control-label">Credit Card CVV</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="cccsv" placeholder="Credit Card CVV">
		    	</div>
		  	</div>
