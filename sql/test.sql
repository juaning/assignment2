...
SELECT * FROM ASSIGN2.MOVIE_GENRE;
...
SELECT * FROM ASSIGN2.MOVIE_BOOKED;

UPDATE ASSIGN2.MOVIE_BOOKED SET CINEMA_USER_ID=18;

SELECT * FROM ASSIGN2.MOVIE_BOOKED_PAYMENT;

SELECT * FROM ASSIGN2.TIMES WHERE ID=13;

SELECT SUM(seats) FROM ASSIGN2.MOVIE_BOOKED WHERE MOVIE_CINEMA_ID=8 AND TIMES_ID=13;
...
SELECT * FROM ASSIGN2.MOVIE_COMMENT;

UPDATE ASSIGN2.CINEMA_USER SET NICKNAME='test' WHERE ID=2;

DELETE FROM ASSIGN2.CINEMA_USER WHERE USERNAME='test' AND REGISTRATION_CODE IS NOT NULL;
